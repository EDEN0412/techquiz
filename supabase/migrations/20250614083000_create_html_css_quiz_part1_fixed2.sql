...
-- 初級クイズの問題1: HTMLの基本構造
INSERT INTO quiz_question (quiz_id, question_text, question_type, hint, explanation, points, "order", created_at) VALUES
...
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 1),
'<title>', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 1),
'<header>', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 1),
...
-- 初級問題2の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 2),
'color: red;', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 2),
...
-- 初級問題3の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 3),
'<ol>', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 3),
'<ul>', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 3),
...
-- 初級問題4の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 4),
'.menu', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 4),
'#menu', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 4),
...
-- 初級問題5の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 5),
'<img>', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 5),
'<image>', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 1) AND "order" = 5),
...
-- 中級問題1の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 1),
...
-- 中級問題2の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 2),
...
-- 中級問題3の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 3),
...
-- 中級問題4の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 4),
':hover', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 4),
':focus', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 4),
...
-- 中級問題5の回答選択肢
INSERT INTO quiz_answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 5),
'fixed', true, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 5),
'absolute', false, NOW()),
((SELECT id FROM quiz_question WHERE quiz_id = (SELECT id FROM quiz_quiz WHERE category_id = 1 AND difficulty_id = 2) AND "order" = 5),
