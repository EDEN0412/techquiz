...
((SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3), 
...
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 1),
...
-- 上級問題2の回答選択肢
INSERT INTO answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 2),
...
-- 上級問題3の回答選択肢
INSERT INTO answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 3),
'ul > li', true, NOW()),
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 3),
'ul li', false, NOW()),
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 3),
...
-- 上級問題4の回答選択肢
INSERT INTO answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 4),
...
-- 上級問題5の回答選択肢
INSERT INTO answer (question_id, answer_text, is_correct, created_at) VALUES
((SELECT id FROM question WHERE quiz_id = (SELECT id FROM quiz WHERE category_id = 1 AND difficulty_id = 3) AND display_order = 5),
